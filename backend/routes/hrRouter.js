...
router.post("/payroll/run",protect,authorize("HR"),runMonthlyPayroll)
router.get("/payrolls", protect, authorize("HR"), getPayrolls);
router.get("/dashboard-stats", protect, authorize("HR"), getDashboardStats);
